...
(function($, undefined) {
  ...
  $.widget('ui.iviewer', $.ui.mouse, {
    ...
    fit: function(skip_animation) {
      var aspect_ratio =
        this.img_object.orig_width() / this.img_object.orig_height();
    ...
    set_zoom: function(new_zoom, skip_animation, zoom_center) {
      ...
      if (this.current_zoom == 'fit') {
        ...
        var old_y =
          zoom_center.y + Math.round(this.img_object.orig_height() / 2);
      ...
      var new_x = util.scaleValue(
        util.descaleValue(old_x, this.current_zoom),
        new_zoom
      );
      var new_y = util.scaleValue(
    ...
    zoom_by: function(delta, zoom_center) {
      ...
      var next_zoom =
        this.options.zoom_base * Math.pow(this.options.zoom_delta, next_rate);
  ...
  (function() {
    ...
    this.angle = setter(
      function(deg) {
        ...
        jQuery.each(['', '-webkit-', '-moz-', '-o-', '-ms-'], function(
          i,
          prefix
        ) {
